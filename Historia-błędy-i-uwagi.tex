...
Należy dodać, że~jeśli skrót został wprowadzony w~jednym tomie, to~nie
jest już wyjaśniany w~następnych, co~dodatkowo komplikuje sprawę.
...
zaś rozważymy kwartyl górny $\tfrac{ 3 }{ 4 }$ to
wynosi\footnote{Kwartyl górny wybrałem w~ten sposób, że~powyżej niego
  jest 25\% populacji, jego samego zaś umieszczam pośród pozostałych
  75\%.} on~3.4. Wszystkie te liczby są niższe od~podanej
tu~średniej~3.7 roku.
