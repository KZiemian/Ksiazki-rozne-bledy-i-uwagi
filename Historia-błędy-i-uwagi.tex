...
\vspace{\spaceOne} \vspace{\spaceTwo}
% ########################################
...
% \begin{itemize}
% \item[--] \Str{28} Uwaga, że~jeszcze w~latach trzydziestych XIX~w.
%   babcie hiszpańskie straszyły dzieci Napoleonem, jest zapewne
%   pomyłkom. Wojny napoleońskie skończyły~się dopiero w~1815 roku,
%   więc pamiętanie o~nich po kilkunastu latach nie~jest niczym
...
Najprawdopodobniej chodzi tu o~koniec roku 1919. Powinno~się
