...
% ####################
\Work{
  Warren H.~Carroll, Anne W. Carrol \\
...
\start \Str{12} Wcięcia wszystkich akapitów poza pierwszy~są zbyt duże.
...
\Work{
  ...
  \cite{GuerrieroImpagliazzoNajnowszaHistoriaKosciol06} }
...
\Work{
  ...
  modernizacja i~kultura. Tom~I'', \cite{HistoriaPolskiXIXv1} }
...
\Work{
  ...
  Historia neoliberalnej Europy'', \cite{TherNowyLad15} }
...
\Work{
  Masha Gessen \\
  ,,Putin. Człowiek bez twarzy'', \cite{GessenPutin12} }
